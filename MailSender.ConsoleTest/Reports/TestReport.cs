...
namespace GeneratedCode
{
    ...
    {
        public string DataProperty1 { get; set; } = "Hello World!";

        public string DataProperty2 { get; set; } = "123";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00186070", RsidRunAdditionDefault = "00521506", ParagraphId = "0F8D4AAE", TextId = "3D9A1D95" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00521506", RsidRunAdditionDefault = "00521506", ParagraphId = "5C6DABCD", TextId = "7664CD08" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00486E9F", RsidParagraphAddition = "00521506", RsidRunAdditionDefault = "00521506", ParagraphId = "141AABE3", TextId = "0B4EC803" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00486E9F" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00486E9F", RsidR = "00521506" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "0076754B" };
            Rsid rsid1 = new Rsid() { Val = "00186070" };
            Rsid rsid2 = new Rsid() { Val = "00486E9F" };
            Rsid rsid3 = new Rsid() { Val = "00521506" };
            Rsid rsid4 = new Rsid() { Val = "005778AA" };
            Rsid rsid5 = new Rsid() { Val = "005B78AE" };
            Rsid rsid6 = new Rsid() { Val = "0076754B" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "42C02873" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{1F4C876C-3339-41DF-AC0B-6E2A0C4A594D}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Rsid rsid14 = new Rsid() { Val = "00BA5836" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2019-06-01T17:24:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-06-01T17:24:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Павел Шмачилин";
        }

        #region Binary Data
        private string thumbnailPart1Data = "";
